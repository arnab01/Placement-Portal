<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <%@page import="regis.model.company"%> 
...
<body>
<header>
		<nav class="navbar navbar-expand-md navbar-dark" style="background-color: #49c6e5">
	...
	<div class="row">
		...
		<div class="container">
			...
			<table class="table table-bordered">
				...
				<tbody>
					<%ArrayList<company> comp =(ArrayList<company>)request.getAttribute("comp"); 
        for(company c:comp){%> 
